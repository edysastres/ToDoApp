...
namespace ToDoApp.Droid
{
    public class CameraAndroid : DependencyServices.ICamera
    {
        ...
        Task<string> DependencyServices.ICamera.takePhoto()
        {
            ...
            pictureDirectory = new File(Android.OS.Environment.GetExternalStoragePublicDirectory(Android.OS.Environment.DirectoryPictures), "ToDoApp");
            ...
            file = new File(pictureDirectory, string.Format("task_{0}.jpg", Guid.NewGuid()));
